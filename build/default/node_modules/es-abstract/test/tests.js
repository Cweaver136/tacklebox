...
var es2015 = function ES2015(ES, ops, expectedMissing, skips) {
  ...
  test('Call', function (t) {
    ...
    var throwsIfNotCallable = function (notFunc) {
      ...
      }, TypeError, debug(notFunc) + ' (' + typeof notFunc + ') is not callable');
    };
  ...
  test('Set', function (t) {
    ...
    t.test('doesn’t call [[Get]] in conforming strict mode environments', {
      skip: noThrowOnStrictViolation
    }, function (st) {
  ...
  test('CreateDataProperty', function (t) {
    ...
    forEach(v.propertyKeys, function (propertyKey) {
      ...
      t.equal(obj[propertyKey], secondSentinel, debug(secondSentinel) + ' is installed on "' + debug(propertyKey) + '" on the object');
  ...
  test('SetIntegrityLevel', function (t) {
    ...
    t.test('sealed', {
      skip: !Object.preventExtensions || noThrowOnStrictViolation
    }, function (st) {
    ...
    t.test('frozen', {
      skip: !Object.freeze || noThrowOnStrictViolation
    }, function (st) {
