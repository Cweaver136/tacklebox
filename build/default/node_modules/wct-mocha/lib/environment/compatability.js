...
var childrunner_js_1 = require("../childrunner.js"); // polymer-test-tools (and Polymer/tools) support HTML tests where each file is
...
window.addEventListener('message', function (event) {
  ...
  childRunner.ready(); // The name of the suite as exposed to the user.
