...
exports.CONFIG_FILES = ['.mocharc.js', '.mocharc.yaml', '.mocharc.yml', '.mocharc.jsonc', '.mocharc.json'];
...
const parsers = exports.parsers = {
  yaml: filepath => require('js-yaml').safeLoad(fs.readFileSync(filepath, 'utf8')),
  js: filepath => {
  ...
  json: filepath => JSON.parse(require('strip-json-comments')(fs.readFileSync(filepath, 'utf8')))
};
/**
...
exports.findConfig = (cwd = process.cwd()) => {
  const filepath = findUp.sync(exports.CONFIG_FILES, {
    cwd
  });
